...
function Edit({
  ...
  const performSearch = async (resetResults = true) => {
    ...
    try {
      ...
      if (response.results) {
        ...
        setError((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('No results found', 'opensource-media-connect'));
        setSearchResults([]);
      }
    } catch (err) {
      setError((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Error searching Openverse', 'opensource-media-connect'));
  ...
  const imageSizeOptions = [{
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Small', 'opensource-media-connect'),
    value: 'small'
  }, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Medium', 'opensource-media-connect'),
    value: 'medium'
  }, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Large', 'opensource-media-connect'),
    value: 'large'
  }];
  const renderAttribution = media => {
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Creator:', 'opensource-media-connect'), " ", media.creator || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Unknown', 'opensource-media-connect'), " |", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('License:', 'opensource-media-connect'), " ", media.license);
  };
  const MediaSettingsPanel = () => {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Show Attribution', 'opensource-media-connect'),
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Caption', 'opensource-media-connect'),
      value: localCaption,
      ...
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Add a caption to display below the image.', 'opensource-media-connect'),
      __nextHasNoMarginBottom: true
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Alt Text', 'opensource-media-connect'),
      value: localAltText,
      ...
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Alternative text describes your image to people who can\'t see it. Add a short description with its key details.', 'opensource-media-connect'),
      __nextHasNoMarginBottom: true
    })));
  };
  ...
  const renderSearchInterface = () => {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      icon: "search",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Open Source Media Search', 'opensource-media-connect'),
      instructions: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Search for free and openly licensed media from Openverse', 'opensource-media-connect')
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "openverse-search-controls"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Search Query', 'opensource-media-connect'),
      hideLabelFromVision: true,
      value: query,
      onChange: value => setAttributes({
        query: value
      }),
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Enter search terms...', 'opensource-media-connect'),
      __nextHasNoMarginBottom: true,
    ...
    }, isSearching ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, null) : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Search', 'opensource-media-connect')), previousMediaRef.current && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      variant: "secondary",
      onClick: cancelSearch,
      className: "openverse-cancel-search"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Cancel', 'opensource-media-connect'))))), error && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Search Results', 'opensource-media-connect')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, isSearching ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, null) : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Load More', 'opensource-media-connect'))));
  };
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, selectedMedia && !isSearchInterfaceOpen && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.BlockControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarButton, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Replace Media', 'opensource-media-connect'),
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Media Settings', 'opensource-media-connect'),
    initialOpen: true
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Image Size', 'opensource-media-connect'),
    value: imageSize,
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Maximum Width (%)', 'opensource-media-connect'),
    value: maxWidth,
    onChange: value => setAttributes({
      maxWidth: value
    }),
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('openverse-connect/search', {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Open Source Media', 'opensource-media-connect'),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Search and insert media from Openverse', 'opensource-media-connect'),
  icon: 'format-image',
  category: 'media',
  keywords: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('openverse', 'opensource-media-connect'), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('image', 'opensource-media-connect'), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('search', 'opensource-media-connect')],
...
function Save({
  ...
  const renderCaptionAttribution = () => {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("figcaption", {
      className: "wp-element-caption openverse-attribution"
    }, imageCaption && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, imageCaption, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("br", null)), showAttribution && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, "Creator: ", selectedMedia.creator || 'Unknown', " | License: ", selectedMedia.license));
  };
